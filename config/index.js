...
const config = Object.freeze({
  ...
  APP_MAX_USERS: Number(env.APP_MAX_USERS) || 2,
  APP_MAX_PROMPT_MESSAGES: Number(env.APP_MAX_PROMPT_MESSAGES) || 8,
  ...
  OPENAI_COMPLETION_MAX_TOKENS: Number(env.OPENAI_COMPLETION_MAX_TOKENS) || 1280,
